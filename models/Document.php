...
class Document extends BaseModel
{
    ...
    public function setCustomFields()
    {
        ...
        $this->appointments['invoice_services_count'] = $this->getCustomInvoiceServicesCount();
        $this->appointments['invoice_sum'] = $this->getCustomInvoiceSum();
        $this->appointments['invoice_services'] = $this->getCustomInvoicesServices();
        $this->appointments['appointment_id'] = $this->getCustomAppointmentId();
        $this->appointments['user_name'] = $this->getCustomUserName();
        $this->appointments['user_document_number'] = $this->getCustomUserDocumentNumber();
        $this->appointments['user_document_date'] = $this->getCustomUserDocumentDate();
    }
